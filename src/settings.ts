...
function setSvgAttributes(el: Element, attrs: Record<string, string | number>): void {
...
export class YesterdaysWeatherSettingTab extends PluginSettingTab {
    ...
    private addWebsiteSection(containerEl: HTMLElement) {
        ...
        pathBg.setAttribute('d', 'M0 0 C21.12 0 42.24 0 64 0 C64 21.12 64 42.24 64 64 C42.88 64 21.76 64 0 64 C0 42.88 0 21.76 0 0 Z');
        pathBg.setAttribute('fill', '#FBFDFB');
        pathBg.setAttribute('transform', 'translate(0,0)');
        svg.appendChild(pathBg);

        // Add other paths with their attributes
        const paths = [
            {
                d: 'M0 0 C1.36125 0.9590625 1.36125 0.9590625 2.75 1.9375 C5.39221381 3.61428953 6.9898499 4.53689998 10 5 C7.85233416 10.65264091 4.99252344 15.88726144 2.14233398 21.2109375 C1.19258727 22.99046804 0.25547777 24.7762948 -0.68164062 26.5625 C-1.28814453 27.696875 -1.89464844 28.83125 -2.51953125 30 C-3.06714111 31.03125 -3.61475098 32.0625 -4.17895508 33.125 C-6.88854182 37.40279776 -10.09089774 41.32040117 -15 43 C-17.7331543 43.24291992 -17.7331543 43.24291992 -20.82421875 43.23046875 C-21.93474609 43.22853516 -23.04527344 43.22660156 -24.18945312 43.22460938 C-25.92098633 43.20624023 -25.92098633 43.20624023 -27.6875 43.1875 C-29.43643555 43.1865332 -29.43643555 43.1865332 -31.22070312 43.18554688 C-39.85973635 43.14026365 -39.85973635 43.14026365 -41 42 C-41.04063832 40.33382885 -41.042721 38.66611905 -41 37 C-37.30416126 35.15208063 -32.49600489 35.75306786 -28.38476562 35.74609375 C-27.64291016 35.72160156 -26.90105469 35.69710937 -26.13671875 35.671875 C-25.46342529 35.6625293 -24.79013184 35.65318359 -24.09643555 35.64355469 C-19.72046941 34.30023959 -17.39624349 30.64344684 -15.0871582 26.89379883 C-14.49765381 25.75966553 -13.90814941 24.62553223 -13.30078125 23.45703125 C-12.97965866 22.84736008 -12.65853607 22.2376889 -12.3276825 21.60954285 C-11.3138456 19.68163859 -10.3125167 17.74760352 -9.3125 15.8125 C-8.29984289 13.86778454 -7.28455185 11.92452779 -6.2651825 9.98332214 C-5.34617993 8.23109137 -4.43520665 6.47465639 -3.5246582 4.71801758 C-2 2 -2 2 0 0 Z',
                fill: '#078307',
                transform: 'translate(45,16)'
            },
            {
                d: 'M0 0 C0.98033203 -0.01224609 1.96066406 -0.02449219 2.97070312 -0.03710938 C3.90720703 -0.03904297 4.84371094 -0.04097656 5.80859375 -0.04296875 C6.67154053 -0.04707764 7.5344873 -0.05118652 8.42358398 -0.05541992 C10.5625 0.1875 10.5625 0.1875 12.5625 2.1875 C12.02678571 5.72321429 12.02678571 5.72321429 10.5625 7.1875 C9.01294441 7.28649523 7.45896327 7.31829524 5.90625 7.3203125 C4.49666016 7.32224609 4.49666016 7.32224609 3.05859375 7.32421875 C2.06988281 7.32035156 1.08117187 7.31648438 0.0625 7.3125 C-0.92621094 7.31636719 -1.91492188 7.32023437 -2.93359375 7.32421875 C-3.87332031 7.32292969 -4.81304688 7.32164063 -5.78125 7.3203125 C-6.64943359 7.31918457 -7.51761719 7.31805664 -8.41210938 7.31689453 C-10.4375 7.1875 -10.4375 7.1875 -11.4375 6.1875 C-11.5625 3.6875 -11.5625 3.6875 -11.4375 1.1875 C-9.07794489 -1.17205511 -3.16997174 0.00207595 0 0 Z',
                fill: '#0C860C',
                transform: 'translate(15.4375,36.8125)'
            },
            {
                d: 'M0 0 C0.98033203 -0.01224609 1.96066406 -0.02449219 2.97070312 -0.03710938 C3.90720703 -0.03904297 4.84371094 -0.04097656 5.80859375 -0.04296875 C6.67154053 -0.04707764 7.5344873 -0.05118652 8.42358398 -0.05541992 C10.5625 0.1875 10.5625 0.1875 12.5625 2.1875 C12.02678571 5.72321429 12.02678571 5.72321429 10.5625 7.1875 C9.01294441 7.28649523 7.45896327 7.31829524 5.90625 7.3203125 C4.49666016 7.32224609 4.49666016 7.32224609 3.05859375 7.32421875 C2.06988281 7.32035156 1.08117187 7.31648438 0.0625 7.3125 C-0.92621094 7.31636719 -1.91492188 7.32023437 -2.93359375 7.32421875 C-3.87332031 7.32292969 -4.81304688 7.32164063 -5.78125 7.3203125 C-6.64943359 7.31918457 -7.51761719 7.31805664 -8.41210938 7.31689453 C-10.4375 7.1875 -10.4375 7.1875 -11.4375 6.1875 C-11.5625 3.6875 -11.5625 3.6875 -11.4375 1.1875 C-9.07794489 -1.17205511 -3.16997174 0.00207595 0 0 Z',
                fill: '#0C860C',
                transform: 'translate(15.4375,21.8125)'
            },
            {
                d: 'M0 0 C0.98033203 -0.01224609 1.96066406 -0.02449219 2.97070312 -0.03710938 C3.90720703 -0.03904297 4.84371094 -0.04097656 5.80859375 -0.04296875 C6.67154053 -0.04707764 7.5344873 -0.05118652 8.42358398 -0.05541992 C10.5625 0.1875 10.5625 0.1875 12.5625 2.1875 C12.02678571 5.72321429 12.02678571 5.72321429 10.5625 7.1875 C9.01294441 7.28649523 7.45896327 7.31829524 5.90625 7.3203125 C4.49666016 7.32224609 4.49666016 7.32224609 3.05859375 7.32421875 C2.06988281 7.32035156 1.08117187 7.31648438 0.0625 7.3125 C-0.92621094 7.31636719 -1.91492188 7.32023438 -2.93359375 7.32421875 C-3.87332031 7.32292969 -4.81304688 7.32164063 -5.78125 7.3203125 C-6.64943359 7.31918457 -7.51761719 7.31805664 -8.41210938 7.31689453 C-10.4375 7.1875 -10.4375 7.1875 -11.4375 6.1875 C-11.5625 3.6875 -11.5625 3.6875 -11.4375 1.1875 C-9.07794489 -1.17205511 -3.16997174 0.00207595 0 0 Z',
                fill: '#0C860C',
                transform: 'translate(15.4375,6.8125)'
            },
            {
                d: 'M0 0 C3.5 0.25 3.5 0.25 5.5 2.25 C5.75 5.75 5.75 5.75 5.5 9.25 C3.5 11.25 3.5 11.25 0 11.5 C-3.5 11.25 -3.5 11.25 -5.5 9.25 C-5.75 5.75 -5.75 5.75 -5.5 2.25 C-3.5 0.25 -3.5 0.25 0 0 Z',
                fill: '#0C860C',
                transform: 'translate(54.5,4.75)'
            }
        ];
    ...
    private addCoffeeSection(containerEl: HTMLElement) {
        const coffeeDiv = containerEl.createEl('div', { cls: 'buy-me-coffee' });
        ...
        // Add the coffee button svg
        coffeeLink.appendChild(svg);        // Create PayPal logo SVG
        const paypalSvg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
        paypalSvg.setAttribute('width', '150');
        paypalSvg.setAttribute('height', '42');
        paypalSvg.setAttribute('viewBox', '0 0 101 32');
        paypalSvg.setAttribute('fill', 'none');

        // Add PayPal logo paths
        const paypalPaths = [
            {
            ...
            {
                d: 'M 35.437 10.1 L 31.737 10.1 C 31.437 10.1 31.137 10.3 31.137 10.6 L 30.937 11.6 L 30.637 11.4 C 29.837 10.4 28.037 10.1 26.237 10.1 C 22.137 10.1 18.637 13.1 17.937 17.3 C 17.537 19.4 18.037 21.4 19.337 22.7 C 20.437 23.9 22.137 24.4 24.037 24.4 C 27.337 24.4 29.237 22.4 29.237 22.4 L 29.037 23.4 C 28.937 23.8 29.237 24.1 29.637 24.1 L 32.937 24.1 C 33.437 24.1 33.937 23.7 34.037 23.2 L 36.137 10.8 C 36.237 10.5 35.837 10.1 35.437 10.1 Z M 30.337 17.5 C 29.937 19.6 28.237 21.1 26.037 21.1 C 24.937 21.1 24.037 20.8 23.437 20.1 C 22.837 19.4 22.637 18.4 22.837 17.3 C 23.137 15.2 24.937 13.7 27.037 13.7 C 28.137 13.7 29.037 14 29.637 14.7 C 30.237 15.5 30.437 16.5 30.337 17.5 Z',
                fill: '#253B80'
            },
            {
                d: 'M 55.337 10.1 L 51.637 10.1 C 51.237 10.1 50.937 10.3 50.737 10.6 L 45.537 18.4 L 43.337 10.8 C 43.237 10.3 42.737 10 42.337 10 L 38.637 10 C 38.237 10 37.837 10.4 38.037 10.9 L 42.137 23 L 38.237 28.4 C 37.937 28.8 38.237 29.4 38.737 29.4 L 42.437 29.4 C 42.837 29.4 43.137 29.2 43.337 28.9 L 55.937 11 C 56.237 10.6 55.937 10.1 55.337 10.1 Z',
                fill: '#253B80'
            },
            {
            ...
            {
                d: 'M 90.937 10.1 L 87.237 10.1 C 86.937 10.1 86.637 10.3 86.637 10.6 L 86.437 11.6 L 86.137 11.4 C 85.337 10.4 83.537 10.1 81.737 10.1 C 77.637 10.1 74.137 13.1 73.437 17.3 C 73.037 19.4 73.537 21.4 74.837 22.7 C 75.937 23.9 77.637 24.4 79.537 24.4 C 82.837 24.4 84.737 22.4 84.737 22.4 L 84.537 23.4 C 84.437 23.8 84.737 24.1 85.137 24.1 L 88.437 24.1 C 88.937 24.1 89.437 23.7 89.537 23.2 L 91.637 10.8 C 91.637 10.5 91.337 10.1 90.937 10.1 Z M 85.737 17.5 C 85.337 19.6 83.637 21.1 81.437 21.1 C 80.337 21.1 79.437 20.8 78.837 20.1 C 78.237 19.4 78.037 18.4 78.237 17.3 C 78.537 15.2 80.337 13.7 82.437 13.7 C 83.537 13.7 84.437 14 85.037 14.7 C 85.637 15.5 85.837 16.5 85.737 17.5 Z',
                fill: '#179BD7'
            },
            {
                d: 'M 95.337 3.3 L 92.137 23.7 C 92.037 24.1 92.337 24.4 92.737 24.4 L 95.937 24.4 C 96.437 24.4 96.937 24 97.037 23.5 L 100.237 3.5 C 100.337 3.1 100.037 2.8 99.637 2.8 L 96.037 2.8 C 95.637 2.8 95.437 3 95.337 3.3 Z',
                fill: '#179BD7'
            }
        ];

        paypalPaths.forEach(pathData => {
            const path = document.createElementNS('http://www.w3.org/2000/svg', 'path');
            path.setAttribute('d', pathData.d);
            path.setAttribute('fill', pathData.fill);
            paypalSvg.appendChild(path);
        });

        // Add the PayPal button svg
        paypalLink.appendChild(paypalSvg);
    }
}
